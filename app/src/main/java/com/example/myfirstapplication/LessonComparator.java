...
public class LessonComparator implements Comparator<Lesson> {
    ...
    public int compare(Lesson l1, Lesson l2) {
        ...
        if (l1.getNum() == l2.getNum() /*&& l1.getWeeks() == l2.getWeeks()*/) {
            ...
            if (l1.getStartTime() == l2.getStartTime()) {	//same start time
                if (l1.getDay() == l2.getDay()) {
                    ...
                    if (l1.getTypeOfWeeks() == "Odd weeks" && l2.getTypeOfWeeks() == "Even weeks") {
                        return -1;
                    } else if (l1.getTypeOfWeeks() == "Even weeks" && l2.getTypeOfWeeks() == "Odd weeks") {
                        return 1;
